<?php
/*
Template Name:小児歯科ブログ blog_syouni
            	...
            	<div class='row' data-module-type='container'>
                	<div class=' span9' data-module-type='cell'>
                    	<div data-module-type='heading'>
                            <h2 class="design-tmpl h2-cute-yellow" data-default-design="cute" data-default-color="yellow" data-design-class="h2-cute-yellow">
                            小児歯科ブログ
                            </h2>
                        </div>
                    </div>
            	...
            	<div class=' span9' data-module-type='cell'>
                	<div data-module-type='paragraph-editable'>
                          <div data-layout="1">
                            <div>
                             <!-- パンくずリストここから -->
                              <p><a href="<?php echo home_url('/'); ?>" class="" data-page-id="52860a9a6253dc972f00038c" data-heading-id="">立川小児矯正なら近藤歯科クリニック</a>＞<a href="<?php echo home_url('/'); ?>KDC-Column/">近藤歯科クリニックのコラム</a>＞<a href="<?php echo home_url('/'); ?>kdc-column/blog_syouni">小児歯科ブログ一覧</a>＞小児歯科ブログ</p>
                             <!-- パンくずリストここまで -->
                            </div>
                          </div>
                     </div>
...
echo '<li><a href="'.home_url('/').'kdc-column/blog_syouni/?p='.$previous_post->ID.'">&lt;&lt;前の記事</a></li>';	
}
echo '<li><a href="'.home_url('/').'kdc-column/blog_syouni">ブログ一覧</a></li>';	
$next_post = get_next_post();
if($next_post->ID!==NULL){
echo '<li><a href="'.home_url('/').'kdc-column/blog_syouni/?p='.$next_post->ID.'">次の記事&gt;&gt;</a></li>';	
}
?>
                </ul>
              </div>
