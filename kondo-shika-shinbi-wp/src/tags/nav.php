...
class GNav {
	...
	public static function get_post_nav( $taxonomy = "category", $prev_text = "前の記事へ", $next_text = "次の記事へ" ) {
		...
		if ( $prev ) {
			...
			$html .= '<li class="c-post-navs__prev"><a class="c-button is-md is-arrow-rev is-primary is-effect" href="' . $prev_url . '">' . $prev_text . '</a></li>';
		}

		$html .= '<li class="c-post-navs__center"><a href="/news/" class="c-button is-md is-yellow is-base-color is-effect">記事一覧へ</a></li>';
		...
		if ( $next ) {
			...
			$html .= '<li class="c-post-navs__next"><a class="c-button is-primary is-arrow is-md is-effect" href="' . $next_url . '">' . $next_text . '</a></li>';
		}
